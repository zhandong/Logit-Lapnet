...
[Xm,y,L]=SimLassoData(beta1,200,100); % Logistic Lapnet simulate data
...
alpha1=0.2;   % alpha here can also be a vector containing candidates  
...
lerror=logisSimError(Xm1,y1,theta_hat); % L2 norm of the error
