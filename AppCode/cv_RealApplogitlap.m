function [lambda_opt alpha_opt r]=cv_RealApplogitlap(X,y,L,alpha,lambda,nfold)
...
for k=1:sizealpha
 ...
 for i=1:nfold
     for j=1:sizelam
         ...
         eval(fnw);
         %% r is the matrix that contains the residual=|| yi-(1/exp(-theta'*Xi)>0.5) ||_2
...
[err Ind]=min(rmin); alpha_opt=alpha(Ind);
