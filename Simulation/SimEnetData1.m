function [Xm,y,L]=SimEnetData1(theta,n,p)
%% Generate training & testing data in simulations of Elastic Net 
%% The inputs are theta, the dimension of transcription factor: n X p
%% The outputs are matrix Xm, response vector y, graphical Laplacian matrix L
Xm=zeros(n+10*n,p);  
x=randn(n,p);
...
%% The graphical Laplacian matrix for Elastic net is identity matrix
L=eye(n+10*n,n+10*n);